 ...
 */
final class Version20210711122438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT NOT NULL, legal_category_id INT NOT NULL, name VARCHAR(255) NOT NULL, siren VARCHAR(14) NOT NULL, city_of_registration VARCHAR(255) NOT NULL, date_of_registration TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, capital INT NOT NULL, is_published BOOLEAN DEFAULT \'false\' NOT NULL, PRIMARY KEY(id))');
